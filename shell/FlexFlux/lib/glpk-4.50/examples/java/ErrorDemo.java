 ...
 * calling the glpk library, if the error occurs in the callback
 * function.
 *
 * It creates a problem and tries to add -1 row in the callback
 * function. This will cause an error to occur.
 */
