 ...
 * 21 juin 2013 
 */
package parsebionet.applications.flux.flexflux.gui;
...
import parsebionet.applications.flux.flexflux.FlexfluxTest;
import parsebionet.utils.flexconflux.gui.MainFrame;
	...
	public static void main(String[] args) {
		...
		try {
			new MainFrame(FlexfluxTest.okSolvers,
					getClasses("parsebionet.applications.flux.flexflux"));
		...
		while (resources.hasMoreElements()) {
			...
			try {
				...
				while (entries.hasMoreElements()) {
					...
					if (entry
							.contains("parsebionet/applications/flux/flexflux/Flex")) {
